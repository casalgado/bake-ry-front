...
<template>
  ...
  >
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
      <DialogPanel
        class="w-full max-w-md rounded-lg bg-white max-h-[96dvh] overflow-y-auto"
      >
        <div
        ...
        <form @submit="handleSubmit" class="base-card border-none rounded-none">
          <div class="space-y-4">
            ...
            <div>
              ...
              <input type="text" required v-model="formData.name" class="" />
            </div>
            ...
            <div>
              ...
              <input type="email" v-model="formData.email" class="" />
            </div>

            <div>
              <label class=""> Teléfono </label>
              <input type="tel" v-model="formData.phone" class="" />
            </div>

            <div>
              <label class=""> Dirección </label>
              <textarea v-model="formData.address" rows="2" class=""></textarea>
            </div>

            <div>
              <label class=""> Documento de Identidad </label>
              <input type="text" v-model="formData.nationalId" class="" />
            </div>

            <div>
              <label class=""> Fecha de Nacimiento </label>
              <input type="date" v-model="formData.birthday" class="" />
            </div>
            ...
            <div>
              ...
              ></textarea>
                       ...
                       <div
                v-if="error"
                class="p-2 mb-2 text-sm text-danger text-center bg-danger/10 rounded-md"
              >
                {{ error }}
              </div>
            ...
            <div class="flex justify-end gap-2 mt-4">
              ...
              <button type="button" @click="closeDialog" class="utility-btn">
                Cancelar
              </button>
