<template>
  <div class="privacy-policy">
    ...
    <p class="last-updated"><strong>Last updated July 02, 2025</strong></p>

    <p>This Privacy Notice for <strong>Mad Inc</strong> ("<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"), describes how and why we might access, collect, store, use, and/or share ("<strong>process</strong>") your personal information when you use our services ("<strong>Services</strong>"), including when you:</p>

    <ul>
      <li>Download and use our mobile application <strong>(MAD)</strong>, our Facebook application <strong>(MAD)</strong>, or any other application of ours that links to this Privacy Notice</li>
      <li>Use <strong>Customer Service Bot</strong>. A WhatsApp customer service bot that receives customer orders.</li>
      <li>Engage with us in other related ways, including any sales, marketing, or events</li>
    </ul>

    <p><strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <strong>info@carsalhaz.com</strong>.</p>
    ...
    <ol>
      <li><a href="#info-collect" @click="scrollTo('info-collect')">WHAT INFORMATION DO WE COLLECT?</a></li>
      <li><a href="#info-use" @click="scrollTo('info-use')">HOW DO WE PROCESS YOUR INFORMATION?</a></li>
      <li><a href="#info-share" @click="scrollTo('info-share')">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
      <li><a href="#cookies" @click="scrollTo('cookies')">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
      <li><a href="#ai" @click="scrollTo('ai')">DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</a></li>
      <li><a href="#info-retain" @click="scrollTo('info-retain')">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
      <li><a href="#info-safe" @click="scrollTo('info-safe')">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
      <li><a href="#info-minors" @click="scrollTo('info-minors')">DO WE COLLECT INFORMATION FROM MINORS?</a></li>
      <li><a href="#privacy-rights" @click="scrollTo('privacy-rights')">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
      <li><a href="#dnt" @click="scrollTo('dnt')">CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
      <li><a href="#policy-updates" @click="scrollTo('policy-updates')">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
      <li><a href="#contact" @click="scrollTo('contact')">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
      <li><a href="#request" @click="scrollTo('request')">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
    </ol>
    ...
    <h2 id="info-use">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
    ...
    <p>We provide the AI Products through third-party service providers ("AI Service Providers"), including <strong>Anthropic</strong> and <strong>OpenAI</strong>. As outlined in this Privacy Notice, your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products. You must not use the AI Products in any way that violates the terms or policies of any AI Service Provider.</p>
    ...
    <h2 id="info-retain">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
    ...
    <h2 id="info-safe">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
    ...
    <p>If you have questions or comments about your privacy rights, you may email us at <strong>info@carsalhaz.com</strong>.</p>
    ...
    <h2 id="policy-updates">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
    ...
    <p>If you have questions or comments about this notice, you may email us at <strong>info@carsalhaz.com</strong> or contact us by post at:</p>

    <div class="contact-info">
      <strong>Mad Inc</strong><br>
      Carrera 54 # 96 - 133<br>
      Apto 301<br>
    ...
    <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please fill out and submit a <a href="https://app.termly.io/notify/e90c70b6-70d5-42a3-8731-6076705ab47b" target="_blank" rel="noopener noreferrer">data subject access request</a>.</p>
